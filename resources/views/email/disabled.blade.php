...
<head>
    ...
    <title>GoHeart-Notificacion de entrada desahbilitada.</title>
...
<body>
    ...
    <div class="col-12 bg-light p-4 text-center" style="font-size: 1rem;">
        <p>Estimado/a {{$user->name}}, una de tus entradas/eventos ha sido desahbilitada para conocer mas datos pongase en contacto.</p>
        <p>Tenga en cuenta que una entrada desahbilitada se puede recuperar siempre y cuando usted justifique.</p>
        <hr>
        <p> <b> Titulo: </b></p>
